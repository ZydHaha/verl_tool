...
#多轮交互，直到达到上限或所有样本都完成生成
        ...
        for step in range(self.config.max_turns):
            ...
            #print(responses_str,next_obs)
            #print("!!!",next_obs,dones)
...
#！！！进行搜索
        ...
        if do_search and search_queries :
            ...
            search_results = self.batch_search(search_queries) #["dummy search_results !!!" ]* sum([1 for action in cur_actions if action == 'search']) #self.batch_search(search_queries) #
